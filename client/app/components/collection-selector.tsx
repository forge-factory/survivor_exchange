        ...
        {collections.map((collection) => {
          ...
          return (
            <button
              ...
              className={`group inline-flex items-center gap-2.5 rounded-full border px-4 py-2 text-xs font-orbitron uppercase tracking-[0.14em] transition-all duration-200 hover:cursor-pointer ${
                isSelected
