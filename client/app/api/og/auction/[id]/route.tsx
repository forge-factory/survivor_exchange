...
async function fetchAuctionData(
  auctionId: string,
): Promise<{ auction: AuctionData | null; items: AuctionItem[] }> {
...
async function fetchNFTMetadata(
  ...
  try {
    ...
    const data = await response.json();
    const allNFTs =
      data?.data?.tokenBalances?.edges
        ?.map(
          (e: { node: { tokenMetadata: NFTMetadata & { tokenId: string } } }) =>
            e.node.tokenMetadata,
        )
        .filter(Boolean) || [];

    const tokenIdSet = new Set(tokenIds.map((id) => normalizeTokenId(id)));
    return allNFTs.filter((nft: NFTMetadata & { tokenId: string }) =>
      tokenIdSet.has(normalizeTokenId(nft.tokenId)),
    );
  } catch {
    return [];
  }
...
export async function GET(
  ...
  try {
    ...
    if (nfts[0]?.metadata) {
      try {
        ...
        if (
          ...
          const pngMatch = svgContent.match(
    ...
    const isEnded =
      auction.status === "3" ||
      formatTimeRemaining(auction.end_time) === "Ended";
            ...
            <>
              ...
              <div
                style={{
                  ...
                  height: "500px",
                  background:
                    "radial-gradient(circle, rgba(50, 255, 52, 0.15) 0%, rgba(50, 255, 52, 0.05) 30%, transparent 70%)",
                  display: "flex",
                }}
              />
              ...
              <div
                style={{
                  ...
                  height: "600px",
                  background:
                    "radial-gradient(circle, rgba(50, 255, 52, 0.12) 0%, rgba(50, 255, 52, 0.03) 40%, transparent 70%)",
                  display: "flex",
                }}
              />
              {/* Center subtle glow */}
              <div
                style={{
                  ...
                  background:
                    "radial-gradient(ellipse, rgba(50, 255, 52, 0.08) 0%, transparent 60%)",
                  display: "flex",
                }}
              />
            </>
            ...
            <>
              ...
              <div
                style={{
                  ...
                  height: "400px",
                  background:
                    "radial-gradient(circle, rgba(138, 43, 226, 0.25) 0%, rgba(138, 43, 226, 0.1) 30%, transparent 60%)",
                  display: "flex",
                }}
              />
              ...
              <div
                style={{
                  ...
                  height: "500px",
                  background:
                    "radial-gradient(circle, rgba(0, 200, 150, 0.2) 0%, rgba(0, 150, 100, 0.08) 35%, transparent 65%)",
                  display: "flex",
                }}
              />
              ...
              <div
                style={{
                  ...
                  height: "400px",
                  background:
                    "radial-gradient(circle, rgba(50, 255, 52, 0.18) 0%, rgba(50, 255, 52, 0.05) 40%, transparent 70%)",
                  display: "flex",
                }}
              />
              ...
              <div
                style={{
                  ...
                  height: "300px",
                  background:
                    "radial-gradient(circle, rgba(30, 60, 114, 0.3) 0%, rgba(30, 60, 114, 0.1) 40%, transparent 70%)",
                  display: "flex",
                }}
              />
              ...
              <div
                style={{
                  ...
                  height: "250px",
                  background:
                    "radial-gradient(circle, rgba(255, 50, 150, 0.12) 0%, transparent 60%)",
                  display: "flex",
                }}
              />
            </>
              ...
              >
                <div
                  style={{
                    ...
                    boxShadow:
                      "0 0 25px rgba(50, 255, 52, 0.6), inset 0 0 15px rgba(50, 255, 52, 0.2)",
                  }}
                >
                  <span
                    style={{
              ...
              >
                ...
                <div
                  style={{
                    ...
                    borderRadius: "28px",
                    background:
                      "linear-gradient(135deg, #32FF34 0%, #00cc00 50%, #1a8a1c 100%)",
                    boxShadow:
                      "0 0 60px rgba(50, 255, 52, 0.7), 0 0 100px rgba(50, 255, 52, 0.3), inset 0 0 30px rgba(255,255,255,0.1)",
                  }}
                >
                  {/* Inner dark card */}
                  <div
                  ...
                  >
                    {mainImage ? (
                      ...
                      >
                        <span style={{ fontSize: "80px", color: "#32FF34" }}>
                          ?
                        </span>
                      </div>
                    )}
                ...
                {additionalCount > 0 && (
                  <div
                    style={{
                      ...
                      borderRadius: "24px",
                      background:
                        "linear-gradient(135deg, #32FF34 0%, #00cc00 100%)",
                      boxShadow:
                        "0 6px 20px rgba(0,0,0,0.5), 0 0 15px rgba(50, 255, 52, 0.4)",
                    }}
                  >
                    <span
                      style={{
              ...
              >
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      height: "3px",
                      background:
                        "linear-gradient(90deg, #32FF34 0%, transparent 100%)",
                      borderRadius: "2px",
                    }}
                  ></div>
                </div>
                ...
                <span
                  style={{
                    ...
                    lineHeight: "1.05",
                    textShadow:
                      "0 4px 20px rgba(0,0,0,0.7), 0 0 40px rgba(255,255,255,0.1)",
                    marginBottom: "8px",
                  }}
                >
                  {auctionName.length > 14
                    ? auctionName.slice(0, 14) + "..."
                    : auctionName}
                </span>
                ...
                <div
                  style={{
                    ...
                    borderRadius: "20px",
                    background:
                      "linear-gradient(135deg, rgba(50, 255, 52, 0.2) 0%, rgba(0, 150, 0, 0.15) 50%, rgba(0, 80, 0, 0.25) 100%)",
                    border: "4px solid #32FF34",
                    maxWidth: "480px",
                    boxShadow:
                      "0 0 40px rgba(50, 255, 52, 0.4), inset 0 0 30px rgba(50, 255, 52, 0.1)",
                  }}
                >
                  <span
                    style={{
                  ...
                  <span
                    style={{
                      ...
                      fontWeight: "bold",
                      textShadow:
                        "0 0 30px rgba(50, 255, 52, 0.8), 0 0 60px rgba(50, 255, 52, 0.4)",
